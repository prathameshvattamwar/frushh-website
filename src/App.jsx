            ...
            {filteredProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition">
                ...
                <button
                  ...
                  className="w-full py-2 bg-green-500 text-white font-medium rounded-lg hover:bg-green-600 transition flex items-center justify-center gap-2"
                >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-green-500 rounded-2xl p-6 transform md:-translate-y-4">
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex items-center gap-2 text-sm">
                  <i className="fa-solid fa-check text-yellow-300"></i>
                  350ml shakes
                </li>
                <li className="flex items-center gap-2 text-sm">
                  <i className="fa-solid fa-check text-yellow-300"></i>
                  4 skip days per month
                </li>
                <li className="flex items-center gap-2 text-sm">
                  <i className="fa-solid fa-check text-yellow-300"></i>
                  5-day pause option
                  ...
                  {testimonials.map((_, idx) => (
                    <button
                      ...
                      className={`w-2 h-2 rounded-full transition ${
                        idx === currentTestimonial ? 'bg-green-500 w-6' : 'bg-gray-300'
                      }`}
                    />
                  ))}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Fresh natural protein shakes delivered to your gym. 100% natural, no whey powder!
              </p>
            </div>
            <div>
