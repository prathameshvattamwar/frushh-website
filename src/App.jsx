    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              ...
              <button onClick={() => setIsOrderHistoryOpen(true)} className="hidden sm:flex items-center gap-2 px-3 py-2 bg-blue-100 text-blue-600 font-medium rounded-lg hover:bg-blue-200 transition">
            ...
            <button onClick={() => requireLogin(() => openCart())} className="relative flex items-center gap-2 px-3 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition">
            ...
            <button onClick={() => requireLogin(() => window.open(whatsapp, '_blank'))} className="flex items-center gap-2 px-4 py-2 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition">
      ...
      <section className="bg-gradient-to-br from-green-50 to-white py-12 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <button onClick={() => requireLogin(() => window.open(whatsapp, '_blank'))} className="inline-flex items-center gap-2 px-8 py-4 bg-green-500 text-white text-lg font-bold rounded-xl hover:bg-green-600 transition shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {filteredProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition">
                ...
                <button onClick={() => requireLogin(() => { setSelectedProduct(product); setIsProductModalOpen(true); })} className="w-full py-2 bg-green-500 text-white font-medium rounded-lg hover:bg-green-600 transition flex items-center justify-center gap-2">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-800 rounded-2xl p-6">
              ...
              <button onClick={() => requireLogin(() => window.open(whatsapp, '_blank'))} className="block w-full py-3 bg-green-500 text-center font-bold rounded-lg hover:bg-green-600 transition">Subscribe Now</button>
            </div>
            <div className="bg-green-500 rounded-2xl p-6 transform md:-translate-y-4">
              ...
              <button onClick={() => requireLogin(() => window.open(whatsapp, '_blank'))} className="block w-full py-3 bg-white text-green-600 text-center font-bold rounded-lg hover:bg-gray-100 transition">Subscribe Now</button>
            </div>
            <div className="bg-gray-800 rounded-2xl p-6">
              <div className="text-center mb-4">
              ...
              <button onClick={() => requireLogin(() => window.open(whatsapp, '_blank'))} className="block w-full py-3 bg-green-500 text-center font-bold rounded-lg hover:bg-green-600 transition">Order Now</button>
            </div>
          </div>
        </div>
      </section>

      {/* Daily Quiz - Only show if logged in */}
      {user && <Quiz whatsapp={whatsapp} />}

      {/* Quiz Teaser for non-logged in users */}
      {!user && (
        <section className="py-12 px-4 bg-gradient-to-br from-purple-50 to-pink-50">
          <div className="max-w-2xl mx-auto text-center">
            <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="fa-solid fa-brain text-3xl text-purple-600"></i>
            </div>
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-2">Daily Protein Quiz</h2>
            <p className="text-gray-600 mb-6">Test your nutrition knowledge & win FREE shakes!</p>
            <div className="bg-white rounded-xl p-6 shadow-sm mb-6">
              <div className="flex items-center justify-center gap-4 text-sm text-gray-500">
                <div className="flex items-center gap-1">
                  <i className="fa-solid fa-gift text-green-500"></i>
                  <span>Win free shakes</span>
                </div>
                <div className="flex items-center gap-1">
            ...
            <button onClick={openLogin} className="inline-flex items-center gap-2 px-8 py-4 bg-purple-600 text-white font-bold rounded-xl hover:bg-purple-700 transition">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <button onClick={() => requireLogin(() => window.open(whatsapp, '_blank'))} className="inline-flex items-center gap-2 px-4 py-2 bg-green-500 rounded-lg hover:bg-green-600 transition">
      ...
      <button onClick={() => requireLogin(() => window.open(whatsapp, '_blank'))} className="fixed bottom-6 right-6 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 transition z-50">
