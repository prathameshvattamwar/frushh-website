...
function LoginModal() {
  const { showLogin, closeLogin, sendOTP, verifyOTP } = useAuth()
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
        ...
        <div className="bg-green-500 p-4 text-white relative">
          <button 
            onClick={handleClose}
            className="absolute right-4 top-4 w-8 h-8 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/30"
          >
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-white/80">
              ...
              {step === 'otp' && 'Enter the OTP sent via WhatsApp'}
          ...
          {step === 'phone' && (
            <form onSubmit={handlePhoneSubmit}>
              <div className="mb-4">
                ...
                <div className="flex">
                  ...
                  <input
                    ...
                    maxLength={10}
                    className="flex-1 px-4 py-3 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
                    autoFocus
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-green-500 text-white font-bold rounded-lg hover:bg-green-600 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
            ...
            <div>
              ...
              <div className="mb-6 p-4 bg-green-50 rounded-lg border border-green-200">
                <p className="text-sm text-gray-700 mb-3">
                  ...
                  Click below to send OTP via WhatsApp:
                </p>
                
                  href={whatsappLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 w-full py-3 bg-green-500 text-white font-bold rounded-lg hover:bg-green-600 transition"
                >
                  <i className="fa-brands fa-whatsapp text-xl"></i>
                  Send OTP on WhatsApp
                </a>
                <p className="text-xs text-gray-500 mt-2 text-center">
                  Your OTP: <span className="font-mono font-bold text-green-600">{generatedOTP}</span>
                </p>
              </div>
              ...
              <form onSubmit={handleOTPSubmit}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    placeholder="123456"
                    maxLength={6}
                    className="w-full px-4 py-3 text-center text-2xl tracking-widest font-mono border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
                    autoFocus
                  />
                </div>
            ...
            <form onSubmit={handleProfileSubmit}>
              <div className="mb-4 p-3 bg-green-50 rounded-lg border border-green-200 text-center">
                ...
                <p className="text-green-700 font-medium">
                  Welcome! You earned 50 points!
                </p>
                <p className="text-xs text-green-600">
                  Complete profile for 25 more points
                </p>
              </div>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  <i className="fa-solid fa-dumbbell mr-2 text-gray-400"></i>
                  Your Gym (for delivery)
                </label>
                <input
                  type="text"
                  value={gym}
